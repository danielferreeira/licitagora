...
-- Função para gerar relatório de licitações por período com nome de função único
CREATE OR REPLACE FUNCTION public.gerar_relatorio_licitacoes_v2(
...
-- Função para gerar relatório de clientes com nome de função único
CREATE OR REPLACE FUNCTION public.gerar_relatorio_clientes_v2(
    p_data_inicio TIMESTAMP WITH TIME ZONE DEFAULT NULL,
    p_data_fim TIMESTAMP WITH TIME ZONE DEFAULT NULL
)
RETURNS TABLE (
...
-- Função para gerar relatório de desempenho com nome de função único
CREATE OR REPLACE FUNCTION public.gerar_relatorio_desempenho_v2(
    p_data_inicio TIMESTAMP WITH TIME ZONE DEFAULT NULL,
    p_data_fim TIMESTAMP WITH TIME ZONE DEFAULT NULL
)
RETURNS TABLE (
